import { NoteInput, NoteList, SearchField } from '../components'
...
export default function MainSection({ notes, addNote, onDelete, onArchive, archivedNotes, isArchive ,onSearch }) {
	return (
		<main className='container h-auto py-10 mx-auto md:py-60 lg:py-40'>
			<img id='notesInput' className='absolute left-0 z-0' src={rectangleMain} alt='' />
			...
			<section className='flex flex-col gap-10 my-16 sm:my-32 '>
				<div id='activeNotes' className='md:mx-5 '>
				...
				<div id='archiveNotes' className='flex flex-col sm:mx-5 sm:block'>
