...
export default function NoteItem({ id, title, body, createdAt, onDelete, onArchive, isArchive }) {
	...
	return (
		<div className='mx-5 max-w-96 min-w-[19rem] sm:mx-auto relative p-5 pb-10 text-neutral-100 rounded-lg border-t border-[#E5E7EB] min-h-[20rem] max-h-[55rem] bg-[#334155] my-5 overflow-auto'>
